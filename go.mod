module github.com/randyahx/inscription-go-sdk

go 1.17

require github.com/cosmos/cosmos-sdk v0.46.7
...
replace (
	github.com/cosmos/cosmos-sdk v0.46.7 => github.com/bnb-chain/inscription-cosmos-sdk v0.0.3
